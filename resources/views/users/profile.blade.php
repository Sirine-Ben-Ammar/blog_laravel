...
@php
  $genderArray = ['Male', 'Female'];
   $provinceArray = ['El Haouaria', 'kelibia', 'Korba', 'Menzel Temim', 'Nabeul', 'El Hammemet', 'Selimen', 'Grombelia'];
@endphp
...
<form method="POST" action="{{route('profile.update')}}">
    ...
    <div class="form-group">
      ...
      <input type="text" name="facebook" class="form-control" value="{{$user->profile->facebook}}" placeholder="facebook URL">
    </div>
...
<div class="form-group">
      <select  class="custom-select mr-sm-2" name="province" >
